...
### Performs the jitter operation on an input image. this amounts to rotating the image +/- MAX_ROTATION,
### in ROT_INCREMENT degree increments. 20 and 3, would generate rotations at [-20,-17,-14,...20].

### Each rotated image is translated to a maximum of MAX_TRANSLATE units in any direction, and you may specify
### the number of translations using TRANSLATE_DIRS. 
### This divides 360 degrees TRANSLATE_DIRS times, starting at 0 degrees.

MAX_ROTATION = 20 #degrees cc and ccw
MAX_TRANSLATE = 5 #pixels offset limit
ROT_INCREMENT = 3 #rotation increment value
...
def gen_rotations(img):
	...
	deltas = range(-1*MAX_ROTATION, 1+MAX_ROTATION, ROT_INCREMENT)
